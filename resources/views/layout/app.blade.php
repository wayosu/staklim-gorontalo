                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @role('admin')
                                <a class="dropdown-item" href="{{ route('admin.pengaturan.akun') }}">
                                @endrole
                                @role('kepalabidang')
                                <a class="dropdown-item" href="{{ route('kepalabidang.pengaturan.akun') }}">
                                @endrole
                                @role('user')
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Stasiun Klimatologi Bone Bolango {{ date('Y') }}.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
